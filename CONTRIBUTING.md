# Contributing to @pplancq/lab-clean-architecture-react
...
[@pplancq/lab-clean-architecture-react Code of Conduct](https://github.com/pplancq/.github/blob/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code.

## I Have a Question

> If you want to ask a question, we assume that you have read the available [Documentation](https://github.com/pplancq/lab-clean-architecture-react).

Before you ask a question, it is best to search for existing [Issues](https://github.com/pplancq/lab-clean-architecture-react/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/pplancq/lab-clean-architecture-react/issues/new).
